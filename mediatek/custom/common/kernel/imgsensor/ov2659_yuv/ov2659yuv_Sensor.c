...
static void OV2659_set_AE_mode(kal_bool AE_enable)
{
	...
	if (AE_enable == KAL_TRUE)
	{
		...
		OV2659_write_cmos_sensor(0x3503, (AeTemp & 0xF8));
	}
	else
	{
...
static void OV2659WriteShutter(kal_uint32 shutter)
{
	...
	shutter*=16;
	OV2659_write_cmos_sensor(0x3502, shutter & 0xF0);
	OV2659_write_cmos_sensor(0x3501, shutter >>8);
	OV2659_write_cmos_sensor(0x3500, (shutter >> 16) & 0xFF);
	if(extra_exposure_lines>0)
	{
		OV2659_write_cmos_sensor(0x3507, extra_exposure_lines);
		OV2659_write_cmos_sensor(0x3506, extra_exposure_lines >> 8);
	}
	else
	{
...
void OV2659_night_mode(kal_bool enable)
{
	...
	else
	{
		...
		OV2659_write_cmos_sensor(0x3a02,0x08);
		OV2659_write_cmos_sensor(0x3a03,0xA9);
		OV2659_write_cmos_sensor(0x3a14,0x08);
		OV2659_write_cmos_sensor(0x3a15,0xA9);
	}
}
...
void OV2659_set_brightness(UINT16 para)
{
	...
	switch (para)
	{
		...
		case ISP_BRIGHT_MIDDLE:
			OV2659_write_cmos_sensor(0x3208,0x00);
			OV2659_write_cmos_sensor(0x3a0f,0x45);
			OV2659_write_cmos_sensor(0x3a10,0x42);
			OV2659_write_cmos_sensor(0x3a11,0x71);
			OV2659_write_cmos_sensor(0x3a1b,0x45);
			OV2659_write_cmos_sensor(0x3a1e,0x42);
			OV2659_write_cmos_sensor(0x3a1f,0x10);
			OV2659_write_cmos_sensor(0x3208,0x10);
			OV2659_write_cmos_sensor(0x3208,0xa0);
			break;
		case ISP_BRIGHT_LOW:
...
void OV2659_set_saturation(UINT16 para)
{
	...
	switch (para)
	{
		case ISP_SAT_HIGH:
			...
			OV2659_write_cmos_sensor(0x5073,0x1e);
			OV2659_write_cmos_sensor(0x5074,0x88);
			OV2659_write_cmos_sensor(0x5075,0xa6);
			OV2659_write_cmos_sensor(0x5076,0xa6);
			OV2659_write_cmos_sensor(0x5077,0xa1);
		...
		case ISP_SAT_MIDDLE:
			...
			OV2659_write_cmos_sensor(0x5074,0x91);
			OV2659_write_cmos_sensor(0x5075,0xb1);
			OV2659_write_cmos_sensor(0x5076,0x8b);
			OV2659_write_cmos_sensor(0x5077,0x86);
		...
		case ISP_SAT_LOW:
			...
			OV2659_write_cmos_sensor(0x5071,0x5b);
			OV2659_write_cmos_sensor(0x5072,0x05);
			OV2659_write_cmos_sensor(0x5073,0x19);
			OV2659_write_cmos_sensor(0x5074,0x70);
			OV2659_write_cmos_sensor(0x5075,0x89);
			OV2659_write_cmos_sensor(0x5076,0x89);
			OV2659_write_cmos_sensor(0x5077,0x85);
			OV2659_write_cmos_sensor(0x5078,0x04);
			OV2659_write_cmos_sensor(0x5079,0x98);
			OV2659_write_cmos_sensor(0x507a,0x01);
			OV2659_write_cmos_sensor(0x3208,0x10);
...
{
	kal_uint32 gain = 0, tmp_gain = 0, shutter = 0;
	...
	if(!gain)
		tmp_gain = 1;
	OV2659_write_cmos_sensor(0x350B,tmp_gain);
...
static void OV2659SetDummy(kal_uint32 dummy_pixels, kal_uint32 dummy_lines)
{
	...
	if (dummy_lines > 0)
	{
		...
		temp_reg = (temp_reg1 | (temp_reg2 << 8));
		temp_reg += dummy_lines;
		OV2659_write_cmos_sensor(0x380F,temp_reg);
		OV2659_write_cmos_sensor(0x380E,(temp_reg>>8));
	}
}
...
static kal_uint32 OV2659ReadShutter(void)
{
	...
	spin_lock(&ov2659_drv_lock);
	OV2659Sensor.PreviewShutter  = (temp_reg1 << 12) | 0x10*temp_reg2 |(temp_reg3 >> 4) & 0xffff;
	spin_unlock(&ov2659_drv_lock);
...
static kal_uint32 OV2659ReadSensorGain(void)
{
	...
	sensor_gain=OV2659_read_cmos_sensor(0x350B);
...
BOOL OV2659_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		case AWB_MODE_OFF:
			...
			OV2659_write_cmos_sensor(0x3406,0x00);
			break;
		case AWB_MODE_AUTO:
			OV2659_write_cmos_sensor(0x3406,0x00);
		...
		case AWB_MODE_TUNGSTEN:
			...
			OV2659_write_cmos_sensor(0x3402,0x04);
			OV2659_write_cmos_sensor(0x3403,0x00);
			OV2659_write_cmos_sensor(0x3404,0x50);
...
static kal_uint32 OV2659_GetSensorID(kal_uint32 *sensorID)
{
	...
	for(i=0;i<3;i++)
	{
		...
		{
			OV2659SENSORDB("[OV2659_GetSensorIDMYYY] sensorID=%x\n", sensor_id);
			//*sensorID =0xffffffff;
...
static void OV2659InitialSetting(void)
{
	...
	OV2659_write_cmos_sensor(0x3003,0x80);
	...
	OV2659_write_cmos_sensor(0x500f,0x40);
	OV2659_write_cmos_sensor(0x5010,0x43);
	...
	OV2659_write_cmos_sensor(0x5016,0x40);
	OV2659_write_cmos_sensor(0x5017,0x3b);
	...
	OV2659_write_cmos_sensor(0x501d,0x40);
	OV2659_write_cmos_sensor(0x501e,0x31);
	OV2659_write_cmos_sensor(0x501f,0x00);
	OV2659_write_cmos_sensor(0x5020,0x66);	
	OV2659_write_cmos_sensor(0x5025,0x10);
	OV2659_write_cmos_sensor(0x5026,0x15);
	OV2659_write_cmos_sensor(0x5027,0x21);
	OV2659_write_cmos_sensor(0x5028,0x38);
	OV2659_write_cmos_sensor(0x5029,0x46);
	OV2659_write_cmos_sensor(0x502a,0x54);
	OV2659_write_cmos_sensor(0x502b,0x62);
	OV2659_write_cmos_sensor(0x502c,0x6d);
	OV2659_write_cmos_sensor(0x502d,0x7b);
	OV2659_write_cmos_sensor(0x502e,0x89);
	OV2659_write_cmos_sensor(0x502f,0x9e);
	OV2659_write_cmos_sensor(0x5030,0xad);
	OV2659_write_cmos_sensor(0x5031,0xc9);
	OV2659_write_cmos_sensor(0x5032,0xdb);
	OV2659_write_cmos_sensor(0x5033,0xe9);
	OV2659_write_cmos_sensor(0x5034,0x1e);
	OV2659_write_cmos_sensor(0x5070,0x20);
	OV2659_write_cmos_sensor(0x5071,0x5b);
	OV2659_write_cmos_sensor(0x5072,0x05);
	OV2659_write_cmos_sensor(0x5073,0x1f);
	...
	OV2659_write_cmos_sensor(0x5079,0x98);
	OV2659_write_cmos_sensor(0x507a,0x01);
	OV2659_write_cmos_sensor(0x5035,0xfa);
	OV2659_write_cmos_sensor(0x5036,0x11);
	OV2659_write_cmos_sensor(0x5037,0x92);
	OV2659_write_cmos_sensor(0x5038,0x21);
	OV2659_write_cmos_sensor(0x5039,0xe0);
	OV2659_write_cmos_sensor(0x503a,0x01);
	OV2659_write_cmos_sensor(0x503c,0x11);
	OV2659_write_cmos_sensor(0x503d,0x0f);
	OV2659_write_cmos_sensor(0x503e,0x18);
	OV2659_write_cmos_sensor(0x503f,0x5f);
	OV2659_write_cmos_sensor(0x5040,0x5f);
	OV2659_write_cmos_sensor(0x5041,0xa1);
	OV2659_write_cmos_sensor(0x5042,0x88);
	OV2659_write_cmos_sensor(0x5043,0x16);
	OV2659_write_cmos_sensor(0x5044,0x29);
	OV2659_write_cmos_sensor(0x5045,0x4d);
	OV2659_write_cmos_sensor(0x5046,0x3c);
	...
	OV2659_write_cmos_sensor(0x3a0f,0x3e);
	OV2659_write_cmos_sensor(0x3a10,0x35);
	OV2659_write_cmos_sensor(0x3a11,0x55);
	OV2659_write_cmos_sensor(0x3a1b,0x3e);
	OV2659_write_cmos_sensor(0x3a1e,0x35);
...
static void OV2659PreviewSetting(void)
{
	...
	OV2659_write_cmos_sensor(0x3500,(OV2659Sensor.PreviewShutter>>12)&0xff);
	OV2659_write_cmos_sensor(0x3501,(OV2659Sensor.PreviewShutter>>4)&0xff);
	OV2659_write_cmos_sensor(0x3502,(OV2659Sensor.PreviewShutter*16)&0xf0);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	{
		if(SENSOR_MODE_ZSD != OV2659Sensor.SensorMode)
		{
...
UINT32 OV2659GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	...
	pSensorResolution->SensorPreviewWidth=OV2659_IMAGE_SENSOR_SVGA_WIDTH - 8;
	pSensorResolution->SensorPreviewHeight=OV2659_IMAGE_SENSOR_SVGA_HEIGHT - 8;
	pSensorResolution->SensorFullWidth=OV2659_IMAGE_SENSOR_UVGA_WITDH - 16;
	pSensorResolution->SensorFullHeight=OV2659_IMAGE_SENSOR_UVGA_HEIGHT - 16;
	pSensorResolution->SensorVideoWidth=OV2659_IMAGE_SENSOR_SVGA_WIDTH - 8;
	pSensorResolution->SensorVideoHeight=OV2659_IMAGE_SENSOR_SVGA_HEIGHT - 8;
	return ERROR_NONE;
}
					 ...
					 MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->SensorPreviewResolutionX= OV2659_IMAGE_SENSOR_SVGA_WIDTH - 8;
	pSensorInfo->SensorPreviewResolutionY= OV2659_IMAGE_SENSOR_SVGA_HEIGHT - 8;
	pSensorInfo->SensorFullResolutionX= OV2659_IMAGE_SENSOR_UVGA_WITDH - 8;
	pSensorInfo->SensorFullResolutionY= OV2659_IMAGE_SENSOR_UVGA_HEIGHT - 8;
...
BOOL OV2659_set_param_effect(UINT16 para)
{
	...
	{
		case MEFFECT_OFF:
			OV2659_write_cmos_sensor(0x507B,0x00);
			break;
		case MEFFECT_SEPIA:
		...
		case MEFFECT_NEGATIVE:
			OV2659_write_cmos_sensor(0x507B,0x40);
			break;
		...
		case MEFFECT_SEPIABLUE:
			...
			break;
		case MEFFECT_MONO:
			OV2659_write_cmos_sensor(0x507B,0x20);
			break;
		default:
			return KAL_FALSE;
	}
